...
void CPreferences::LoadParaFile(UINT item)
{
	...
	if (ReadFile())
	{
		...
		if (PARA_PRJ == (mask&PARA_PRJ))
		{
			...
			//m_strCurrentProjectName = GetValue(L"projectSetting",L"CurrentProject");
			SerIP = GetValue(L"projectSetting", L"SerIP");
			IPMask = GetValue(L"projectSetting", L"IPMASK");
			...
			m_trigger_delay_time = GetValueI(L"projectSetting", L"DELAYFORTRIGGER");
		}
		if (PARA_IMAGE == (mask&PARA_IMAGE))
		{
			...
			//add	 
			TDROI1.x = GetValueF(L"IMAGE_SETTING", L"TDROI1_x");
			TDROI1.y = GetValueF(L"IMAGE_SETTING", L"TDROI1_y");

			TDROI1.w = GetValueF(L"IMAGE_SETTING", L"TDROI1_w");
			TDROI1.h = GetValueF(L"IMAGE_SETTING", L"TDROI1_h");

			TDROI2.x = GetValueF(L"IMAGE_SETTING", L"TDROI2_x");
			TDROI2.y = GetValueF(L"IMAGE_SETTING", L"TDROI2_y");

			TDROI2.w = GetValueF(L"IMAGE_SETTING", L"TDROI2_w");
			TDROI2.h = GetValueF(L"IMAGE_SETTING", L"TDROI2_h");

			BDROI1.x = GetValueF(L"IMAGE_SETTING", L"BDROI1_x");
			BDROI1.y = GetValueF(L"IMAGE_SETTING", L"BDROI1_y");

			BDROI1.w = GetValueF(L"IMAGE_SETTING", L"BDROI1_w");
			BDROI1.h = GetValueF(L"IMAGE_SETTING", L"BDROI1_h");

			BDROI2.x = GetValueF(L"IMAGE_SETTING", L"BDROI2_x");
			BDROI2.y = GetValueF(L"IMAGE_SETTING", L"BDROI2_y");

			BDROI2.w = GetValueF(L"IMAGE_SETTING", L"BDROI2_w");
			BDROI2.h = GetValueF(L"IMAGE_SETTING", L"BDROI2_h");
			...
			top_area1 = GetValueF(L"IMAGE_SETTING", L"TAREA1");
			top_area2 = GetValueF(L"IMAGE_SETTING", L"TAREA2");
			top_area_uplimit = GetValueF(L"IMAGE_SETTING", L"TAREAUP");
			top_area_downlimit = GetValueF(L"IMAGE_SETTING", L"TAREADOWN");
			...
			bottom_area1  = GetValueF(L"IMAGE_SETTING", L"BAREA1");
			bottom_area2 = GetValueF(L"IMAGE_SETTING", L"BAREA2");
			bottom_area_uplimit = GetValueF(L"IMAGE_SETTING", L"BAREAUP");
			bottom_area_downlimit = GetValueF(L"IMAGE_SETTING", L"BAREADOWN");
			...
			m_FstCam.explosure = GetValueI(L"IMAGE_SETTING", L"TOPCAMEPS");
			m_FstCam.gain = GetValueI(L"IMAGE_SETTING", L"TOPCAMGAIN");
			m_FstCam.delaysnap = GetValueI(L"IMAGE_SETTING", L"TOPCAMDELAY");

			m_SndCam.explosure = GetValueI(L"IMAGE_SETTING", L"BOTCAMEPS");
			m_SndCam.gain = GetValueI(L"IMAGE_SETTING", L"BOTCAMGAIN");
			m_SndCam.delaysnap = GetValueI(L"IMAGE_SETTING", L"BOTCAMDELAY");
		}
		...
		if (PARA_IO == (mask&PARA_IO))
		{
			...
			m_FstMtr.BackSpeed = GetValueI(L"IOCARD_SETTING", L"FSTMOTRBKSPD");
			...
			m_SndMtr.BackSpeed = GetValueI(L"IOCARD_SETTING", L"SNDMOTRBKSPD");
...
void CPreferences::SaveParaFile(UINT item)
{
	...
	{
		//m_strCurrentProjectName = GetValue(L"projectSetting",L"CurrentProject");
		SetValue(L"projectSetting", L"SerIP", SerIP);
		SetValue(L"projectSetting", L"IPMASK", IPMask);
		...
		SetValueI(L"projectSetting", L"DELAYFORTRIGGER", m_trigger_delay_time);
	...
	if(PARA_IMAGE==(mask&PARA_IMAGE))
	{
		...
		//add
		SetValueF(L"IMAGE_SETTING", L"TDROI1_x", TDROI1.x);
		SetValueF(L"IMAGE_SETTING", L"TDROI1_y", TDROI1.y);

		SetValueF(L"IMAGE_SETTING", L"TDROI1_w", TDROI1.w);
		SetValueF(L"IMAGE_SETTING", L"TDROI1_h", TDROI1.h);

		SetValueF(L"IMAGE_SETTING", L"TDROI2_x", TDROI2.x);
		SetValueF(L"IMAGE_SETTING", L"TDROI2_y", TDROI2.y);

		SetValueF(L"IMAGE_SETTING", L"TDROI2_w", TDROI2.w);
		SetValueF(L"IMAGE_SETTING", L"TDROI2_h", TDROI2.h);

		SetValueF(L"IMAGE_SETTING", L"BDROI1_x", BDROI1.x);
		SetValueF(L"IMAGE_SETTING", L"BDROI1_y", BDROI1.y);

		SetValueF(L"IMAGE_SETTING", L"BDROI1_w", BDROI1.w);
		SetValueF(L"IMAGE_SETTING", L"BDROI1_h", BDROI1.h);

		SetValueF(L"IMAGE_SETTING", L"BDROI2_x", BDROI2.x);
		SetValueF(L"IMAGE_SETTING", L"BDROI2_y", BDROI2.y);

		SetValueF(L"IMAGE_SETTING", L"BDROI2_w", BDROI2.w);
		SetValueF(L"IMAGE_SETTING", L"BDROI2_h", BDROI2.h);
		...
		SetValueF(L"IMAGE_SETTING", L"TAREA1", top_area1);
		SetValueF(L"IMAGE_SETTING", L"TAREA2", top_area2);
		SetValueF(L"IMAGE_SETTING", L"TAREAUP", top_area_uplimit);
		SetValueF(L"IMAGE_SETTING", L"TAREADOWN", top_area_downlimit);
		...
		SetValueF(L"IMAGE_SETTING", L"BAREA1", bottom_area1);
		SetValueF(L"IMAGE_SETTING", L"BAREA2", bottom_area2);
		SetValueF(L"IMAGE_SETTING", L"BAREAUP", bottom_area_uplimit);
		SetValueF(L"IMAGE_SETTING", L"BAREADOWN", bottom_area_downlimit);
		...
		SetValueI(L"IMAGE_SETTING", L"TOPCAMEPS", m_FstCam.explosure);
		SetValueI(L"IMAGE_SETTING", L"TOPCAMGAIN", m_FstCam.gain);
		SetValueI(L"IMAGE_SETTING", L"TOPCAMDELAY", m_FstCam.delaysnap);

		SetValueI(L"IMAGE_SETTING", L"BOTCAMEPS", m_SndCam.explosure);
		SetValueI(L"IMAGE_SETTING", L"BOTCAMGAIN", m_SndCam.gain);
		SetValueI(L"IMAGE_SETTING", L"BOTCAMDELAY", m_SndCam.delaysnap);
	}
	if(PARA_IO==(mask&PARA_IO))
	{
		...
		SetValueI(L"IOCARD_SETTING", L"FSTMOTRBKSPD", m_FstMtr.BackSpeed);
		...
		SetValueI(L"IOCARD_SETTING", L"SNDMOTRBKSPD", m_SndMtr.BackSpeed);
...
void CPreferences::InitData()
{
	...
	TDROI1.x = TDROI1.y = TDROI1.w = TDROI1.h = 0;
	TDROI2 = BDROI1 = BDROI2 = TDROI1;

	//原图W方向缩放尺寸
	m_topwScaleTo = 300; m_tophScaleTo = 1920;
	m_botwScaleTo = 300; m_bothScaleTo = 1920;
	...
	top_area_downlimit = 5;
	top_area_uplimit = 200000;

	bottom_area_downlimit = 5;
	bottom_area_uplimit = 200000;
	//缩放比例,这个需要计算，但是却不用
	m_TopRatio = -1.0f;
	m_BottomRatio = -1.0f;
	...
	m_FstMtr.No = 0;
	m_FstMtr.InitSpeed = 12500;
	m_FstMtr.MaxSpeed = 60000;
	m_FstMtr.BackSpeed = 60000;
	m_FstMtr.Waves = -96244;
	m_FstMtr.Tacc = 0.05;
	m_FstMtr.compansate = 0;
	m_SndMtr = m_FstMtr;

	m_SndMtr.No = 1;
	m_SndMtr.Waves = -101446;
//	

	m_FstCam.explosure = 300;
	m_FstCam.gain = 4096;
	m_FstCam.delaysnap = 100;
