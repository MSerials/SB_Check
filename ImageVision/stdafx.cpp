...
CString show_roi_msg(UINT id)
{
	...
	case TDROI_RECT1:return L"请画相机一堵孔一检测框";
	case TDROI_RECT2:return L"请画相机一堵孔二检测框";
	case BDROI_RECT1:return L"请画相机二堵孔一检测框";
	case BDROI_RECT2:return L"请画相机二堵孔二检测框";
	case TNROI_RECT:return L"请画相机一排除框";
	case BNROI_RECT:return L"请画相机二排除框";
