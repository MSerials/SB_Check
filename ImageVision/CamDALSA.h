...
public:
	...
	BOOL SetExposureMode(int var){ return AcqDevice->SetFeatureValue("ExposureMode", (UINT32)var); }
	BOOL SetExposure(int var){ return AcqDevice->SetFeatureValue("ExposureTime", (UINT32)var); }
	BOOL SetParaExposure(int var){ return AcqDevice->SetParameter(CORACQ_PRM_CONNECTOR_EXPOSURE_INPUT, var); }
	int	 GetParaExposure(){ int value;  AcqDevice->SetParameter(CORACQ_PRM_CONNECTOR_EXPOSURE_INPUT, &value); return value; }
	BOOL SaveCCF(char *str){ return AcqDevice->SaveFeatures(str); }
