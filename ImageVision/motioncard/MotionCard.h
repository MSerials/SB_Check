...
#define IN_ENABLE					122			//y 轴的远点 限位感应器能够使用不做通用隔离 - x原点感应器不用

#define IN_ISGETTINGBAR				1			//外面的机器人输出正在抓取物料的信号		//9
#define MOTOR2_ORIGIN				2			//第二轴原点感应器 板卡标识					//10

#define IN_PRESSURE					3			//负压检测									//11
#define MOTOR1_UP_LIMIT				4			//第一轴上限 板卡标识						//12
#define MOTOR1_DOWN_LIMIT			5			//第一轴下限 板卡标识						//13

#define MOTOR2_UP_LIMIT				6			//第二轴上限 板卡标识						//14
#define MOTOR2_DOWN_LIMIT			7			//第二轴下限 板卡标识						//15

#define IN_CYL_UP					8			//气缸上限									//16
#define IN_CYL_DOWN					9			//气缸下限									//17

#define IN_START					10			//启动按钮板卡标识							//18
#define IN_FIRST_DETECT_PRODUCT		11			//第一工位检测物料							//19
#define IN_SECOND_DETECT_PRODUCT	12			//第二工位检测物料板卡标识					//32
#define IN_EMGENCY					13			//急停按钮 板卡表示							//33
#define IN_ALM1						14			//电机报警1 板卡标识						//34
#define IN_ALM2						15			//电机报警2 板卡标识						//35

												//24V+										//36
												//0V										//37
#define OUT_DETECT_OVER				1			//检测完成信号								//20
#define OUT_DETECTING				2			//检测中信号								//21
#define OUT_RUN						3			//程序运行信号								//22
#define OUT_SRV						4           //电机使能									//23
#define OUT_NG						5           //输出NG									//24
#define OUT_OK						6			//输出OK									//25
#define OUT_CYL						7			//气缸										//26
#define OUT_PRESSURE				8			//气压电磁阀								//27
...
public:
	...
	struct _Controller
	{
		DWORD AutoGetBarDelay;													//应客户的要求，进行自动检测
