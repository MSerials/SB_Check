...
public:
	...
	int m_trigger_delay_time; //触发抓取延时
	...
	float top_area_uplimit, top_area_downlimit;
	float bottom_area_uplimit, bottom_area_downlimit;

	float top_threshold, top_train_score, top_match_score, top_area1, top_area2; //阈值上下限
	float bottom_threshold, bottom_train_score, bottom_match_score, bottom_area1, bottom_area2;
